...
sheet_R = pd.read_excel(r'C:\Users\rahul\Project\OUT policy\supply_chain_results_1.xlsx', sheet_name = 'Wholesaler')
sheet_R = sheet_R[['Replenishment quantity','Beginning inventory','Inventory position', 'Retailer order','Allocated quantity', 'Ending inventory', 'Forecast', 'Order up to level', 'Order quantity', 'Lost sales']]
...
best_params = {
    ...
    'learning_rate': 0.62,  # Learning rate
    'loss': 'square'
}
