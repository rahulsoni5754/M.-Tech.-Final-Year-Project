...
x = data[['Replenishment quantity','Beginning inventory','Inventory position', 'Ending inventory', 'Forecast', 'Order up to level']]
y = data[['Order quantity']]
...
with open('R_XGB_final_model_pruned.pkl', 'wb') as file:
...
with open('R_XGB_final_model_pruned.pkl', 'rb') as file:
