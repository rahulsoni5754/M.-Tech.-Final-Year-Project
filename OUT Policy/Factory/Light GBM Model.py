...
p = data[['Replenishment quantity','Beginning inventory','Inventory position', 'Distributor order','Allocated quantity', 'Ending inventory', 'Forecast', 'Order up to level', 'Lost sales']]
...
x = data[['Beginning inventory','Inventory position', 'Distributor order', 'Ending inventory', 'Forecast', 'Order up to level']]
y = data[['Order quantity']]
...
import math
input_data = pd.DataFrame({'Replenishment quantity': [0], 'Beginning inventory': [107],'Inventory position': [107],'Forecast': [37],'Order up to level': [111]})
