...
sheet_R = pd.read_excel(r'C:\Users\rahul\Project\OUT policy\supply_chain_results_1.xlsx', sheet_name = 'Distributor')
sheet_R = sheet_R[['Replenishment quantity','Beginning inventory','Inventory position', 'Wholesaler order','Allocated quantity', 'Ending inventory', 'Forecast', 'Order up to level', 'Order quantity', 'Lost sales']]
...
import math
input_data = pd.DataFrame({'Inventory position': [36],'Forecast': [17], 'Order up to level': [51]})
