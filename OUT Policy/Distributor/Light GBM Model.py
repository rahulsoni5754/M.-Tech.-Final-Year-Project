...
sheet_D = pd.read_excel(r'C:\Users\rahul\Project\OUT policy\supply_chain_results_1.xlsx', sheet_name = 'Distributor')
sheet_D = sheet_D[['Replenishment quantity','Beginning inventory','Inventory position', 'Wholesaler order','Allocated quantity', 'Ending inventory', 'Forecast', 'Order up to level', 'Order quantity', 'Lost sales']]
...
p = data[['Replenishment quantity','Beginning inventory','Inventory position', 'Wholesaler order','Allocated quantity', 'Ending inventory', 'Forecast', 'Order up to level', 'Lost sales']]
...
x = data[['Replenishment quantity','Beginning inventory','Inventory position', 'Wholesaler order','Allocated quantity', 'Ending inventory', 'Forecast', 'Order up to level', 'Lost sales']]
...
x = data[['Beginning inventory','Inventory position', 'Wholesaler order', 'Forecast', 'Order up to level']]
y = data[['Order quantity']]
...
import math
input_data = pd.DataFrame({'Replenishment quantity': [0],'Beginning inventory': [0],'Inventory position': [23],'Forecast': [17],'Order up to level': [51]})
