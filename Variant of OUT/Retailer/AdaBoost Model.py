...
x = data[['Beginning inventory', 'Inventory position', 'Forecast', 'Order up to level', 'EDR']]
y = data[['Order quantity']]
...
import math
input_data = pd.DataFrame({'Beginning inventory': [18],'Inventory position': [36],'Forecast': [17], 'Order up to level': [51],'EDR': [17]})
