...
x = data[['Beginning inventory', 'Inventory position', 'Forecast']]
y = data[['Order quantity']]
...
import math
input_data = pd.DataFrame({'Replenishment quantity': [10],'Beginning inventory': [14],'Inventory position': [36],'Forecast': [17], 'Order up to level': [51], 'EDR': [17]})
