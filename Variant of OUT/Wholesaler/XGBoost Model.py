...
x = data[['Replenishment quantity', 'Beginning inventory', 'Inventory position', 'Allocated quantity', 'Forecast', 'Order up to level', 'Lost sales']]
y = data[['Order quantity']]
...
import math
input_data = pd.DataFrame({'Replenishment quantity': [14],'Beginning inventory': [11],'Inventory position': [36],'Forecast': [17], 'Order up to level': [51]})
