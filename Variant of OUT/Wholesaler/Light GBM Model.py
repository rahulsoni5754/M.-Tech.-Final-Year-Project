...
sheet_W = pd.read_excel(r'C:\Users\rahul\Project\Variant of OUT Policy\supply_chain_results_2.xlsx', sheet_name = 'Wholesaler')
...
p = data[['Replenishment quantity','Beginning inventory','Inventory position', 'Retailer order','Allocated quantity', 'Ending inventory', 'Forecast', 'Order up to level', 'EDR', 'Lost sales']]
...
x = data[['Replenishment quantity', 'Beginning inventory','Inventory position', 'Forecast', 'Order up to level', 'EDR']]
y = data[['Order quantity']]
