...
sheet_R = pd.read_excel(r'C:\Users\rahul\OneDrive\Desktop\Project Work\S4\S4 Final Evaluation\Comparative Analysis\Excel Simulation(Variant).xlsx', sheet_name = 'Sheet_R')
sheet_W = pd.read_excel(r'C:\Users\rahul\OneDrive\Desktop\Project Work\S4\S4 Final Evaluation\Comparative Analysis\Excel Simulation(Variant).xlsx', sheet_name = 'Sheet_W')
sheet_D = pd.read_excel(r'C:\Users\rahul\OneDrive\Desktop\Project Work\S4\S4 Final Evaluation\Comparative Analysis\Excel Simulation(Variant).xlsx', sheet_name = 'Sheet_D')
sheet_F = pd.read_excel(r'C:\Users\rahul\OneDrive\Desktop\Project Work\S4\S4 Final Evaluation\Comparative Analysis\Excel Simulation(Variant).xlsx', sheet_name = 'Sheet_F')



with open(r'C:\Users\rahul\Project\Variant of OUT Policy\Retailer Stage\R_LGB_final_model_pruned.pkl', 'rb') as file:
    retailer_model = pickle.load(file)
    
with open(r'C:\Users\rahul\Project\Variant of OUT Policy\Wholesaler Stage\W_LGB_final_model_pruned.pkl', 'rb') as file:
    wholesaler_model = pickle.load(file)

with open(r'C:\Users\rahul\Project\Variant of OUT Policy\Distributor Stage\D_LGB_final_model_pruned.pkl', 'rb') as file:
    distributor_model = pickle.load(file)

with open(r'C:\Users\rahul\Project\Variant of OUT Policy\Factory Stage\F_LGB_final_model_pruned.pkl', 'rb') as file:
...
while t <= Maxit:
    ...
    Retailer_features = pd.DataFrame([[Retailer_inventory_position, Retailer_forecast, Retailer_order_up_to_level]], columns=['Retailer_inventory_position', 'Retailer_forecast', 'Retailer_order_up_to_level'])
    ...
    Wholesaler_features = pd.DataFrame([[Wholesaler_replenishment_quantity, Wholesaler_beginning_inventory, Wholesaler_inventory_position, Wholesaler_forecast, Wholesaler_order_up_to_level, Wholesaler_EDR]], columns=['Wholesaler_replenishment_quantity', 'Wholesaler_beginning_inventory', 'Wholesaler_inventory_position', 'Wholesaler_forecast', 'Wholesaler_order_up_to_level', 'Wholesaler_EDR'])
    ...
    Distributor_features = pd.DataFrame([[Distributor_inventory_position, Distributor_forecast, Distributor_order_up_to_level]], columns=['Distributor_inventory_position', 'Distributor_forecast', 'Distributor_order_up_to_level'])
    ...
    Factory_features = pd.DataFrame([[Factory_beginning_inventory, Factory_inventory_position, Factory_forecast, Factory_order_up_to_level]], columns=['Factory_beginning_inventory', 'Factory_inventory_position', 'Factory_forecast', 'Factory_order_up_to_level'])
...
with pd.ExcelWriter('variant_of_OUT_testing_result_6.xlsx') as writer:
...
#load the excel file    
excel_file = pd.ExcelFile('variant_of_OUT_testing_result_6.xlsx')
#print(excel_file)
