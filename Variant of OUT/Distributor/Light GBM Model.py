...
p = data[['Replenishment quantity','Beginning inventory','Inventory position', 'Wholesaler order','Allocated quantity', 'Ending inventory', 'Forecast', 'Order up to level', 'EDR','Lost sales']]
