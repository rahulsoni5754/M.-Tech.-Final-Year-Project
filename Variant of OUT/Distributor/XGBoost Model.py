...
sheet_D = pd.read_excel(r'C:\Users\rahul\Project\Variant of OUT Policy\supply_chain_results_2.xlsx', sheet_name = 'Distributor')
...
x = data[['Beginning inventory','Inventory position', 'Forecast', 'Order up to level', 'Lost sales']]
y = data[['Order quantity']]
...
import math
input_data = pd.DataFrame({'Beginning inventory': [59], 'Inventory position': [59],'Wholesaler order': [0],'Ending inventory':[59],'Forecast': [29], 'Order up to level': [97], 'EDR': [29]})
