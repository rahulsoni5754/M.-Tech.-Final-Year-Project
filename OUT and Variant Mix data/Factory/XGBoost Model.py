...
sheet_F = pd.read_excel(r'C:\Users\rahul\Project\OUT and Variant mix data\Mix data.xlsx', sheet_name = 'Factory')
...
x = data[['Beginning inventory','Inventory position', 'Ending inventory', 'Forecast', 'Order up to level', 'EDR', 'Lost sales']]
y = data[['Order quantity']]
