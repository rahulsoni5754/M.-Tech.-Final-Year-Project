...
while t <= Maxit:
    ...
    Retailer_order_quantity = max(0, Retailer_order_up_to_level - Retailer_inventory_position)
    ...
    Wholesaler_order_quantity = max(0, Wholesaler_order_up_to_level - Wholesaler_inventory_position)
    ...
    Distributor_order_quantity = max(0, Distributor_order_up_to_level - Distributor_inventory_position)
    ...
    Factory_order_quantity = max(0, Factory_order_up_to_level - Factory_inventory_position)
...
with pd.ExcelWriter('supply_chain_results_1.xlsx') as writer:
...
#load the excel file    
excel_file = pd.ExcelFile('supply_chain_results_1.xlsx')
#print(excel_file)
