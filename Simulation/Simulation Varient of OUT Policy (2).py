...
while t <= Maxit:
    ...
    Retailer_order_quantity = (Retailer_order_up_to_level - Retailer_inventory_position) if (Retailer_inventory_position < Retailer_order_up_to_level and (Retailer_order_up_to_level - Retailer_inventory_position) > Retailer_EDR) else (Retailer_EDR if (Retailer_inventory_position < Retailer_order_up_to_level and (Retailer_order_up_to_level - Retailer_inventory_position) <= Retailer_EDR) else 0)
    ...
    Wholesaler_order_quantity = (Wholesaler_order_up_to_level - Wholesaler_inventory_position) if (Wholesaler_inventory_position < Wholesaler_order_up_to_level and (Wholesaler_order_up_to_level - Wholesaler_inventory_position) > Wholesaler_EDR) else (Wholesaler_EDR if (Wholesaler_inventory_position < Wholesaler_order_up_to_level and (Wholesaler_order_up_to_level - Wholesaler_inventory_position) <= Wholesaler_EDR) else 0)
    ...
    Distributor_order_quantity = (Distributor_order_up_to_level - Distributor_inventory_position) if (Distributor_inventory_position < Distributor_order_up_to_level and (Distributor_order_up_to_level - Distributor_inventory_position) > Distributor_EDR) else (Distributor_EDR if (Distributor_inventory_position < Distributor_order_up_to_level and (Distributor_order_up_to_level - Distributor_inventory_position) <= Distributor_EDR) else 0)
    ...
    Factory_order_quantity = (Factory_order_up_to_level - Factory_inventory_position) if (Factory_inventory_position < Factory_order_up_to_level and (Factory_order_up_to_level - Factory_inventory_position) > Factory_EDR) else (Factory_EDR if (Factory_inventory_position < Factory_order_up_to_level and (Factory_order_up_to_level - Factory_inventory_position) <= Factory_EDR) else 0)
...
with pd.ExcelWriter('supply_chain_results_2.xlsx') as writer:
...
#load the excel file    
excel_file = pd.ExcelFile('supply_chain_results_2.xlsx')
#print(excel_file)
